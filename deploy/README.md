...
| **[Edge · Pi 5](edge/)** | RPi 5 (arm64) | `docker compose -f deploy/edge/docker/docker-compose.rpi.yml up -d` | Up to 4 cameras, NCNN |
...
- [`edge/`](edge/): Raspberry Pi, both Docker (Pi 5) and native (Zero 2 W, 3B).
